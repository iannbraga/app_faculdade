...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference("Discipline.count") do
      post disciplines_url, params: { discipline: { completed: @discipline.completed, status: @discipline.status, title: @discipline.title } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { completed: @discipline.completed, status: @discipline.status, title: @discipline.title } }
